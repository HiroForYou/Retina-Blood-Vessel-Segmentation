...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private static final PageData[] PAGES = new PageData[] {
            ...
            new PageData(
                    R.string.welcome_page_brain_segmentation_title,
                    R.drawable.brain_examples,
                    R.string.welcome_page_brain_segmentation_description),
            new PageData(
                    R.string.welcome_page_retina_segmentation_title,
                    R.drawable.retina,
                    R.string.welcome_page_retina_segmentation_description)
    };
